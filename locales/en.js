...
const en = {
  ...
  revenue: {
    title: "Cashback",
    subtitle: "Monitor your cashback.",
    recentEarnings: "Recent Cashbacks",
    withdraw: "Withdraw",
    availableBalance: "Available Balance",
    totalEarned: "Total Cashback",
    transactions: "Transactions",
    recentTransactions: "Recent Cashback Transactions",
    withdrawEarnings: "Withdraw",
  ...
  docs: {
    ...
    revenueSharing: "Cashback: 10% to creator, 10% to platform, 10+% to costs, up to 70% to cashback.",
    customerReturns: "",
    slidingIncomeWindow: "Sliding Cashback Window",
    ...
    customersEarn: "Get cashback",
    customersTrack: "Track your cashback",
  ...
  support: {
    ...
    faq_what_is_cointent_a: "Co-Intent is a platform that enables collaborative funding of digital products. Users can submit or fund product ideas, while executors create these products. Once completed, products are tokenized as NFTs, and get cashback.",
    faq_how_earn_q: "How can I get cashback?",
    faq_how_earn_a: "When you order a product, you receive an NFT representing your ownership. As the product sells, you receive a cashback. The cashback model allocates up to 70% of sales to NFT holders, with the remaining split between creators and the platform.",
  ...
  // Revenue Calculator
  calculator: {
    title: "Accrued Cashback Calculator (Precise Simulation)",
    initialInvestment: {
      title: "Step 1: Initial Purchase",
      amount: "Initial Purchase Amount",
      tokenPrice: "Token Price",
      prepaymentCustomers: "Estimated Number of Prepayers:",
      prepaymentHint: "= Ceiling(Purchase Amount / Token Price). They cover the Creator's fee."
    },
    distribution: {
    ...
    benefits: {
      ...
      earlyInvestor: "Early Adopter",
      midInvestor: "Mid Adopter",
      lateInvestor: "Late Adopter",
      investmentPaysBack: "Cashback will pay back after",
      sales: "sales",
      at: "With",
      payback: "payback"
    },
    yourToken: {
      title: "Your token #",
      accruedIncome: "Accrued cashback:",
    ...
    overallStats: {
      ...
      totalRevenue: "Total cashback:",
      prepaidTokens: "Prepaid tokens:",
      tokensPaidBack: "Tokens that reached cashback:"
    },
    paybackInfo: {
      title: "Cashback Moment Information",
      saleNumber: "Sale #:",
      totalRevenue: "Total cashback:",
    ...
    comparison: {
      ...
      highPriorityDesc: "Early adopters receive cashback very quickly.",
      balancedTitle: "Balanced (80%):",
      balancedDesc: "Medium cashback speed for early adopters",
      equalTitle: "Equal (60%):",
      equalDesc: "Less pronounced advantage for early adopters. More fair distribution, but slower cashback.",
    ...
    errors: {
      ...
      negativeInvestmentError: "Cashback amount cannot be negative.",
  ...
  hero: {
    ...
    quote: "Here's a new way to get an excellent product and great cashback!",
  }
};
